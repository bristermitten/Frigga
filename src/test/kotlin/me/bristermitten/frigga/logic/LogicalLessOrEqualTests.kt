...
class LogicalLessOrEqualTests : FriggaTest() {

    @Test
    fun `Assert Correct Functionality of Less Or Equal Operator with Ints`() {
        val code = """
            4 <= 3
        """.trimIndent()
    ...
    @Test
    fun `Assert Correct Functionality of Less Or Equal Operator with Ints 2`() {
        val code = """
            4 <= 4
        """.trimIndent()
    ...
    @Test
    fun `Assert Correct Functionality of Less Or Equal Operator with Int and Dec`() {
        val code = """
            4 <= 3.5
        """.trimIndent()
    ...
    @Test
    fun `Assert Correct Functionality of Less Or Equal Operator with Int and Dec 2 `() {
        val code = """
            9.0 <= 9
        """.trimIndent()
    ...
    fun `Assert Correct Functionality of Less Or Equal Operator with Random Decs`() {
        val a = Math.random()
        val b = Math.random()
        val code = """
            $a <= $b
