...
object NodeTransformers
{
	private val TRANSFORMERS = mapOf<Class<out ParserRuleContext>, NodeTransformer<*>>(
		...
		PropertyAssignmentContext::class.java to DeclarationTransformer,

		StandlonePropertyDeclarationStatementContext::class.java to StandaloneDeclarationTransformer,
		...
		PropertyDeclarationStatementContext::class.java to delegateTransformer(
			DeclarationTransformer,
			PropertyDeclarationStatementContext::propertyDeclaration
		),
